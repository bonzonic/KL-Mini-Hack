        ...
        <header className=" nav-container text-black">
          <nav className="flex justify-between">
            <div className="flex flex-row items-center">
              <NavLink
                className="flex items-center text-black my-5 mx-3 transition duration-500 hover:scale-110"
                to="/"
              >
            ...
            <div className="flex flex-row items-center">
              {loggedIn ? (
                <span className="nav-list-item font-bold" onClick={handleLog}>
                  Log In
                </span>
              ) : (
                <NavLink to="login" className="nav-list-item">
                  Log In
                </NavLink>
              )}
              <NavLink
                to="profile"
                className="rounded-full bg-gray-100 p-1 mr-2 shadow-lg border-2 border-solid border-teal-600 transition duration-500 hover:scale-110"
              >
                <img
                  src={profileLogo}
                  className="w-6 h-6 !fill-white profile-icon-nav"
                  alt="Profile Logo"
                />
              </NavLink>
            </div>
